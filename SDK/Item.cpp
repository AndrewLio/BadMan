...
ItemStack::ItemStack(const ItemStack &src) {
	...
	static ItemStackCopyConstructor_t ItemStackCopyConstructor = reinterpret_cast<ItemStackCopyConstructor_t>(FindSignature("48 89 5C 24 ? 48 89 74 24 ? 48 89 4C 24 ? 57 48 83 EC 20 48 8B FA 48 8B F1 E8 ? ? ? ? 90 48 8D 05 ? ? ? ? 48 89 06 48 8D 8E"));
	ItemStackCopyConstructor(*this, src);
	this->setVtable();
}
//48 89 5C 24 ? 48 89 74 24 ? 48 89 4C 24 ? 57 48 83 EC 20 48 8B FA 48 8B F1 E8 ? ? ? ? 90 48 8D 05 ? ? ? ? 48 89 06 48 8D 8E
//48 89 5C 24 ? 48 89 74 24 ? 48 89 4C 24 ? 57 48 83 EC 20 48 8B FA 48 8B F1 E8 ? ? ? ? 90 48 8D 05 ? ? ? ? 48 89 06 48 8D 8E ? ? ? ? E8 ? ? ? ? 90 48 8D 97 ? ? ? ? 48 8D 8E ? ? ? ? E8 ? ? ? ? 90 48 8B C6 48 8B 5C 24 ? 48 8B 74 24 ? 48 83 C4 20 5F C3 
//48 89 4C 24 ? 53 55 56 57 41 54 41 56 41 57 48 83 EC ? 48 8B EA
...
void ItemDescriptor::fromStack(ItemStack *item) {  // all credit to BadMan continued and floppy dolphin for this
	using ItemDescriptor_ctorT = void (*)(ItemDescriptor *, ItemStack *);
	static ItemDescriptor_ctorT ItemDescriptor_ctor = (ItemDescriptor_ctorT)FindSignature("48 89 5C 24 ? 55 56 57 48 83 EC 50 48 8B 05 ? ? ? ? 48 33 C4 48 89 44 24 ? 41 8B E8 48 8B DA");
	ItemDescriptor_ctor(this, item);
}
//48 89 5C 24 ? 55 56 57 48 83 EC 50 48 8B 05 ? ? ? ? 48 33 C4 48 89 44 24 ? 41 8B E8 48 8B DA
